...
export const ICON = {
  ...
  /* dropper */
  pipette: svg('<path d="M13.9 6.5 17.3 3.1a2.6 2.6 0 0 1 3.6 3.6L17.5 10.1a2.6 2.6 0 0 1-3.6-3.6z" fill="currentColor"/>' + '<path d="M12.3 7.5 16.5 11.7"/>' + '<path d="M12.1 9.7 3.7 18.1a1.6 1.6 0 0 0 2.2 2.2l8.4-8.4"/>'),
